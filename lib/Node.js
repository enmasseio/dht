...
// TODO: when receiving a message from another node (onPing, onFindContact, ...), the k-bucket for the senders nodeID must be updated using onStoreContact
 ...
 * @param {Id} key
 * @param {*} value
 * @return {Promise.<Contact[]>}  Resolves with the list of contacts where the
 *                                value has been stored. Returned contacts
