 ...
 */
exports.sha1String = function sha1String (string) {
  return sha1(string);
};

/**
 * Convert an sha1 string to a byte array
 * @param {String} string
 * @return {Number[]} Returns a byte array with numbers
 */
exports.sha1ToArray = function (string) {
  var array = [];

  for (var i = 0, ii = string.length; i < ii; i += 2) {
    array.push(parseInt(string.charAt(i) + string.charAt(i + 1), 16));
  }
 ...
 * @param {Number[]} array    A byte array with numbers
 * @return {String} Returns a hex string
 */
exports.sha1ToString = function (array) {
  var string = '';
